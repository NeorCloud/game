...
Route::group(['prefix' => 'auth', 'as' => 'auth.',], function () {
    Route::group(['prefix' => 'user', 'as' => 'user.',], function () {
        ...
        Route::group(['prefix' => '{user}'], function () {
            ...
            Route::get('edit/avatar', [UserController::class, 'avatar'])
                ->name('edit.avatar')
                ->breadcrumbs(function (Trail $trail, User $user) {
                    $trail->parent('admin.auth.user.edit', $user)
                        ->push(__('Edit Avatar'), route('admin.auth.user.edit.avatar', $user));
                });
            Route::post('/edit', [UserController::class, 'uploadAvatar'])->name('edit.uploadAvatar');
