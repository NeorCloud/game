...
class UserService extends BaseService
{
    ...
    public function update(User $user, array $data = []): User
    {
        ...
        try {
            ...
            if (! $user->isMasterAdmin() && $user->id != Auth::user()->id) {
    ...
    public function updateAvatar(User $user, array $data = [], $location = null): User
    {
        if ($data['avatar_type'] == 'gravatar') {
            $data['avatar_location'] = null;
        } elseif ($data['avatar_type'] == 'storage') {
            $data['avatar_location'] = $location;
        } else {
            throw new GeneralException(__('There is a problem to change this user avatar. Please try again.'));
        }
